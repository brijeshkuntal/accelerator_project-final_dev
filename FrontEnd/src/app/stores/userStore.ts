...
//         return !!this.user;
    ...
    // to call api for getting details of current user
    getUser = async () => {
        ...
        // to call api for registring user
    register = async (creds: UserFormValues) => {
        ...
        try {
            ...
            if(!!user.data.errors)                                   // error
            {              
                if (user.data.errors[0].message==="UserError, User Already Exists! ")
